...
namespace NextOne
{
    ...
    public class LevelGenerator : MonoBehaviour
    {
        ...
        /// <returns></returns>
        private int ChunkNeeded_i(int size_i)
        {
            //In real coordinates /!\
        ...
        private void RoomPlacement(GameObject room)
        {
            ...
            if (goodPosition == true)
            {
                ...
                AddRoom newRoom = GameObject.Instantiate(room, this.Rooms.transform).GetComponent<AddRoom>();
        ...
        /// <returns></returns>
        private List<Point> BFS(Point[,] map, Point entry, Point exit)
        {
        ...
        /// <param name="z"></param>
        /// <returns></returns>
        private int GetTypeCor(bool[,] map, int x, int z)
        {
            /* 0 => width
             * 1 => hight
             * 2 => BL
        ...
        private void MarkRoute(bool[,] map, List<Point> route)
        {
            if (route.Count > 1)
            {
            ...
            for (int x = 0; x < size; x++)
            {
                for (int z = 0; z < size; z++)
                {
                    if (map[x, z])
                    {
                        ...
                        {
                            case 0:
                                Instantiate(corridorLR, position, Quaternion.identity, this.Corridors.transform);
                                break;
                            case 1:
                                Instantiate(corridorBT, position, Quaternion.identity, this.Corridors.transform);
                                break;
                            case 2:
                                Instantiate(corridorBL, position, Quaternion.identity, this.Corridors.transform);
                                break;
                            case 3:
                                Instantiate(corridorBR, position, Quaternion.identity, this.Corridors.transform);
                                break;
                            case 4:
                                Instantiate(corridorTL, position, Quaternion.identity, this.Corridors.transform);
                                break;
                            case 5:
                                Instantiate(corridorTR, position, Quaternion.identity, this.Corridors.transform);
                                break;
                            case 6:
                                Instantiate(corridorBLR, position, Quaternion.identity, this.Corridors.transform);
                                break;
                            case 7:
                                Instantiate(corridorTLR, position, Quaternion.identity, this.Corridors.transform);
                                break;
                            case 8:
                                Instantiate(corridorBTL, position, Quaternion.identity, this.Corridors.transform);
                                break;
                            case 9:
                                Instantiate(corridorBTR, position, Quaternion.identity, this.Corridors.transform);
                                break;
                            case 10:
                                Instantiate(corridorAll, position, Quaternion.identity, this.Corridors.transform);
                                break;
                            case 11:
                                Instantiate(doorT, position, Quaternion.identity, this.Corridors.transform);
                                break;
                            case 12:
                                Instantiate(doorB, position, Quaternion.identity, this.Corridors.transform);
                                break;
                            case 13:
                                Instantiate(doorL, position, Quaternion.identity, this.Corridors.transform);
                                break;
                            case 14:
                                Instantiate(doorR, position, Quaternion.identity, this.Corridors.transform);
                                break;
                        }
                    }
                }
